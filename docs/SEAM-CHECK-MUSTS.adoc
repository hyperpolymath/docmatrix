...
| Recon-Silly-Ation | recon-silly-ation | ✗ Reconciliation engine not implemented
| Docubot | recon-silly-ation/Docubot.res | ? Historical path; revalidation required
| Docudactyl | recon-silly-ation/Docudactyl.res | ? Historical path; revalidation required
|===
